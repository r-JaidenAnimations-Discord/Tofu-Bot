...
module.exports = {
	...
	execute: async function(client, message, args) {
        if (!args[0]) {
            try {
                message.channel.send(`You gotta describe the problem ${message.author.username.toLowerCase()}. That's right, your name doesn't deserve to be capitalized you shrimp's head.`)
            } catch (e) {
